export const firstPara = (
  <>
    ...
    and contribute to a workspace. It's important to remember that interns are
    usually in a learning phase and gaining hands-on experience.
  </>
);
...
export const secondPara = (
  <>
    ...
    intern to learn and contribute effectively. Providing guidance and support
    to develop these skills will benefit both the intern and your workspace."
  </>
);
